export const selectCurrentPositions = (state: any) =>
  state.game.currentPositions;
export const selectCurrentPlayerChance = (state: any) =>
  state.game.chancePlayer;
...
export const selectPocketPileSelection = (state: any) =>
  state.game.pileSelectionPlayer;
export const selectCellSelection = (state: any) =>
